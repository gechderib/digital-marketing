...
const EditUser = () => {
  ...
  useEffect(() => {
    editCtx.setImageUrl(user.identifictionPicture);
  }, []);
  ...
  const newData = {
    ...
    identifictionPicture: editCtx.imageUrl,
  };
  const updatedInfo = { newData, id: user._id, token };
  const handleRoleChange = (e) => {
    if (e.target.value === "farmer" || e.target.value === "sse") {
      editCtx.setIsFarmerOrSse(true);
    } else {
      editCtx.setIsFarmerOrSse(false);
      // .setImageUrl("")
    }
