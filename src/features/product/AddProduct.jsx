  ...
  return (
    <div className="w-full bg-white px-8 py-8 flex flex-col rounded-2xl text-gray-700 shadow-none">
      ...
      <form className="mt-8 mb-2  w-full">
        ...
        <button
          onClick={addProduct}
          className="mt-6  flex justify-center items-center w-full select-none rounded-lg bg-pink-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          type="button"
