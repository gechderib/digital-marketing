        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              ...
              <div className="">
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  {offerStatus == "net_err" ? (
                    ...
                    <p className="text-red-600 mb-4 italic animate-bounce">
                      You already ordered this product <span onClick={()=>{
                        offerCtx.setShowOfferModal()
                        navigate("/myorders")
                      }} className="underline cursor-pointer text-thin text-black">update order</span>
                    </p>
                  ) : offerStatus == "faild" ? (
            ...
            <div className=" bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              ...
              >
                {offerStatus == "pending"?<svg aria-hidden="true" class="inline w-5 h-5 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-green-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
